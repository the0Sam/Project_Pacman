...
public class Model extends JPanel implements ActionListener {
    ...
    private final short levelData[] = {
            ...
            // add the numbers together if you need more than one element in a specific block
    };
    ...
    public void movePacman() {
        ...
        if (pacman_x % BLOCK_SIZE == 0 && pacman_y % BLOCK_SIZE == 0) {
            ...
            if (req_dx != 0 || req_dy != 0) {
                if (!((req_dx == -1 && (ch & 1) != 0) || (req_dx == 1 && (ch & 4) != 0)
                || (req_dy == -1 && (ch & 2) != 0) || (req_dy == 1 && (ch & 8) != 0))) {
                    pacmand_x = req_dx;
                    pacmand_y = req_dy;
                }

                // Check if its in standstill
                if ((pacmand_x == -1 && (ch & 1) != 0) || (pacmand_x == 1 && (ch & 4) != 0)
                || (pacmand_y == -1 && (ch & 2) !=0) || (pacmand_y == 1 && (ch & 8) != 0)) {
                    pacmand_x = 0;
                    pacmand_y = 0;
                }
            }
    ...
    private void continueLevel() {
        ...
        for (int i = 0; i< N_GHOSTS; i++) {
            ...
            if (random >= validSpeeds.length) {
                random = validSpeeds.length - 1;
            }
